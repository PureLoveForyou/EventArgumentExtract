...
#         print('我来了', self.hparams.sample_gen)
#         print('测试：', self.hparams)
...
#             print('我来测试', self.model)
#             print('测试generate:', self.model.generate)
#             assert 1==0,''

            # 修改成自己的generate
#             text2text_generator = Text2TextGenerationPipeline(self.mymodel, self.tokenizer)  
#             sample_output = text2text_generator("北京是[MASK]的首都", max_length=50, do_sample=False)
#             print('测试自己的generate:', sample_output)
            # 修改成自己的generate
            # print('测试batch是什么：', batch, batch_idx)
            # print('测试input_token_ids是什么：', batch['input_token_ids'])
