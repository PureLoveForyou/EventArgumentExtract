...
#         self.transformer = BertModel.from_pretrained('fnlp/bart-base-chinese') # 写错了
        self.transformer = BartForConditionalGeneration.from_pretrained("fnlp/bart-base-chinese").model
#         self.mymodel = BartForConditionalGeneration.from_pretrained("fnlp/bart-base-chinese")
#         print('debugging, transformer: ', self.transformer.shared.weight)
#         print('debugging, transformer: ', self.transformer.shared.weight.shape)
#         print('hahha:', self.transformer.embeddings.word_embeddings) # debugging
...
#             print('debugging: transformer output', sequence_output.shape)
#             print('debugging:', self.transformer.shared.weight.shape)
#             assert 1==0,'手动结束'
